...
namespace Training.Services.Log
{
    public static class LogService
    {
        ...
        public static void Event(TrainingContext sqlContext, Microsoft.AspNetCore.Http.HttpRequest request, string content, IDetectionService _detection, string userId)
        {
            try
            {
